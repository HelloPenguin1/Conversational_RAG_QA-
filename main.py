...
if api_key:
    ...
    if uploaded_files:
        ...
        history_aware_retriever = create_history_aware_retriever(llm, retriever, reformulation_prompt)
        ...
        answer_system_prompt = (
            ...
            "Please answer the question as accurately and informatively as "
            "possible using the following retrieved context. "
            "Give a concise but complete answer to the question.\n\n"
            "{context}"
        )
